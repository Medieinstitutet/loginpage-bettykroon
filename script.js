...
function checkLoggedIn(){
    if((localStorage.getItem("user") == null) && (localStorage.getItem("pass") == null)){
        ...
        contentTitle.innerText = "Välkommen till min inloggningssida";
        contentText.innerText = "Vänligen logga in ovan!"
        loggedOut();
    } else {
        myDiv.innerText = ""
        //content.innerText ="INLOGGAD!!!!"
        contentTitle.innerHTML = "Välkommen " + localStorage.getItem("user");
        contentText.innerText = "Vad kul att du loggat in!"
        loggedIn();
    }
}
checkLoggedIn();
